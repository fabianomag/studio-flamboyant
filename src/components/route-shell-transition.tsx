    ...
    <AnimatePresence>
      {activeTransition ? (
        <motion.div
          ...
          className="pointer-events-none fixed inset-y-0 left-0 z-[92] hidden border-r border-white/10 bg-black shadow-[24px_0_60px_rgba(6,17,22,0.08)] lg:block lg:w-64 xl:w-72"
        >
